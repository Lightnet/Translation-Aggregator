...
BabylonWindow::BabylonWindow() : HttpWindow(L"Babylon", L"http://translation.babylon.com/")
{
	host = L"translation.babylon.com";
	path = L"/translate/babylon.php?v=1.0&langpair=%hs%%7C%hs&callback=ret&q=%s";
	requestHeaders = L"";
	impersonateIE = 1;
}
